    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, trainerModel_1["default"].find({})];
                case 1:
                    trainers = _a.sent();
                    console.log(trainers);
                    return [2 /*return*/, trainers];
                case 2:
                    err_1 = _a.sent();
                    console.error(err_1);
...
router.get('/get-all-trainer', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var trainers;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getTrainer()];
            case 1:
                trainers = _a.sent();
...
router.post("/add-new-trainer", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                newHorse = new trainerModel_1["default"]({
                    name: name,
                    age: age,
                    level: level,
