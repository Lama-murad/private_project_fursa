...
function CalendarFun() {
    ...
    var appointments = hooks_1.useAppSelector(registrationSlice_1.selectAppointment);
    var _a = react_1.useState({ title: "", start: new Date(), end: new Date(), name: "", phone: "" }), newEvent = _a[0], setNewEvent = _a[1];
    var _b = react_1.useState({ name: "", start: new Date(), end: new Date(), course: "" }), registration = _b[0], setRegistration = _b[1];
    ...
    function handleAddEvent() {
        ...
        if (result)
            ...
            dispatch(registrationSlice_1.addAppointment(newEvent));
    }
    return (react_1["default"].createElement("div", null,
        react_1["default"].createElement("div", { className: "calendar" },
            react_1["default"].createElement("h1", null, "Pick a time for you private lesson"),
